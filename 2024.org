...
MixtureVolumes = [0,30,20,0,0]; # in microliters
...
**** GM3 solution:
Prepare 5mg/ml solution by adding 1mg to 200 ul of chloroform. 
...
|-------------+---------------+--------+--------------|
| DOPC        | 10 mg/ml      | 30 ul  |       99.96% |
| LissRhod-PE | 0.01mg/ml     | 20 ul  |        0.04% |
|             |               |        |              |
